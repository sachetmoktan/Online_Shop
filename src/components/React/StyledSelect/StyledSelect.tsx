      ...
      <div>
        <components.Option {...props}>
            <div className="form-check">
                <input type="checkbox" className="form-check-input" checked={props.isSelected} onChange={() => null} />
                <label className="form-check-label" style={{cursor: 'pointer'}}>{props.label}</label>
            </div>
        </components.Option>
      </div>
    );
...
const ValueContainer = (props) => {
    ...
    return (
      <components.ValueContainer {...props}>
        {selectedCount ?
            getTextByLanguage(`${selectedCount} selected`, `${convertEngToNepNumber(selectedCount)} चयनित`)
            :
 ...
 */
const onMultiCheckboxSelect = ({selected, action, onMultiChange, options}: OnMultiCheckboxSelectProps) => {
        ...
        <Select
            ...
            placeholder={
                placeholder || onInputChange ?
                    getTextByLanguage("Type to Search...", "खोजी गर्न टाइप गर्नुहोस् ...")
                    :
                    getTextByLanguage("Choose Option...", "विकल्प छान्नुहोस ...")
            }
